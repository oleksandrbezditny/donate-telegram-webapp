...
export class Deployer implements Contract {
    ...
    async sendNftOnSale(provider: ContractProvider, via: Sender, value: bigint, nftSaleInfo: NftSaleInfo) {
